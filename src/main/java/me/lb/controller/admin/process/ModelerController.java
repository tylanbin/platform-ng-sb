...
public class ModelerController {
	...
	/**
	 * FIXME: 存储流程模型，这里原来@RequestBody会报错，换成@RequestParam就好了...
	 */
	@ResponseBody
	@RequestMapping(value = "/{id}/save", method = { RequestMethod.PUT, RequestMethod.POST })
	public String save(@PathVariable String id, @RequestParam MultiValueMap<String, String> params) {
		try {
			ObjectMapper om = new ObjectMapper();
			// 更新模型信息
			Model model = repositoryService.getModel(id);
